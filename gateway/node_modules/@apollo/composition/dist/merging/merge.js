...
class Merger {
    ...
    needsJoinField({ sources, parentName, allTypesEqual, mergeContext, }) {
        ...
        const coordinate = (_a = sources.find(federation_internals_1.isDefined)) === null || _a === void 0 ? void 0 : _a.coordinate;
        ...
        for (const argName of argNames) {
            ...
            if (isContextualArray.some((c) => c === true)) {
                isContextualArray.forEach((isContextual, idx) => {
                    var _a, _b;
                    const argument = (_a = sources[idx]) === null || _a === void 0 ? void 0 : _a.argument(argName);
                    ...
                    if (!isContextual && argument && argType && (0, federation_internals_1.isNonNullType)(argType) && argument.defaultValue === undefined) {
                        this.errors.push(federation_internals_1.ERRORS.CONTEXTUAL_ARGUMENT_NOT_CONTEXTUAL_IN_ALL_SUBGRAPHS.err(`Argument "${arg.coordinate}" is contextual in at least one subgraph but in "${argument.coordinate}" it does not have @fromContext, is not nullable and has no default value.`, { nodes: (0, federation_internals_1.sourceASTs)((_b = sources[idx]) === null || _b === void 0 ? void 0 : _b.argument(argName)) }));
                    }
    ...
    getFieldsWithFromContextDirective() {
        const fieldsWithFromContext = new Set();
        for (const subgraph of this.subgraphs) {
            ...
            if ((0, federation_internals_1.isFederationDirectiveDefinedInSchema)(fromContextDirective)) {
                for (const application of fromContextDirective.applications()) {
                    ...
                    (0, federation_internals_1.assert)((0, federation_internals_1.isFieldDefinition)(field), () => `Expected ${application.parent.parent} to be a field`);
